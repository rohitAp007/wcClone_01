...
import com.example.whatsappclone.helper.TabAccessorAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    TabLayout tabLayout;
    TabAccessorAdapter tabAccesorAdapter;
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentUser!=null) {
            ...
            tabAccesorAdapter = new TabAccessorAdapter(getSupportFragmentManager());
